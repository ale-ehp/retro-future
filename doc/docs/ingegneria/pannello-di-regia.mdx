...
Nessuno dei numeri di una scena 3D è giusto a priori: si trovano guardando. Per questo esiste un pannello con oltre 200 cursori che cambiano la scena mentre è in movimento, e che in produzione viene tolto.
