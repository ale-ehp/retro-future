...
Una scena 3D è fluida se ogni frame sta dentro un budget di tempo: 16 millesimi di secondo per averne sessanta al secondo. Questo capitolo dice dove va quel tempo, che cosa è stato misurato davvero e che cosa invece resta un obiettivo.
