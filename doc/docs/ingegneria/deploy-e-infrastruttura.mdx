...
- Misure del 2026-09-21: 102 moduli, 1.435.658 byte, 323.738 in brotli, index.html 114.216 byte.
*/}
...
**Il primo: i moduli sono accoppiati fra loro.** La pagina e i 102 moduli ESM sono una
...
La versione inglese non ha una seconda copia: **non esiste un secondo albero della
...
È la decisione con più conseguenze dopo un deploy.
...
`no-cache` non è `no-store`: il browser rivalida a ogni visita e l'ETag gli fa
tornare un 304 senza corpo, non il file. Il costo della seconda visita non sono i
byte, sono 102 richieste. È un costo che conosco e che ho scelto, e la leva per
...
| moduli serviti | 102, per 1.435.658 byte | `find` e `wc -c`, 2026-09-21 |
| stessi moduli compressi | 323.738 byte | `brotli -q 11`, 2026-09-21 |
