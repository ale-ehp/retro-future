...
file diversi: nessun `renderOrder` del progetto sopra quello dei cartelli, ogni cursore
...
Uno script serve la cartella della demo su un server
...
cui il `renderOrder` dei cartelli e la catena dei pass di post-produzione. Quei valori
...
**La scena “statica” non è ferma.** Con folla
