...
- Un dato veniva passato al terminale da due punti diversi e non veniva letto da
  nessuna parte. L'ha trovato il controllo dei tipi a settembre, e l'ho tolto.
- Il cartello di chi accoglie è stato spostato più a destra perché finiva sopra il
  terminale. Il valore di partenza non ha una ragione scritta: era così dalla prima
  versione.
