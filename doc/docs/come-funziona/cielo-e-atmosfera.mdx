...
Il cielo non è una fotografia: è calcolato, nuvola per nuvola, da un programma che gira sulla GPU. Calcolarlo a ogni frame costerebbe metà del tempo disponibile, e questo capitolo spiega il compromesso che lo rende sostenibile.
