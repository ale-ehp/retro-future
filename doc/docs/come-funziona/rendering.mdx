...
WebGLRenderer con tone mapping ACES e uscita sRGB; catena di post con UnrealBloomPass in fork, FXAA o MSAA 2x, TAA opzionale, upscale in shader e grade finale. L'encode di output sta in un pass solo, l'ultimo. Risoluzione adattiva con budget a soglie, spento in produzione.
...
Un dettaglio che conta: tone mapping e conversione in sRGB, la “codifica di uscita”,
