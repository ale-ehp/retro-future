...
compositore arriva a 6 pass a schermo intero (cielo, scheletro, griglia della
...
cartelli e particelle. Il bloom viene saltato e il pixel ratio limitato. Il
...
perché sono 18 accesi insieme e ognuno durerebbe 1,5 s.
...
- **Tutti gli anelli in un `InstancedMesh`.** 18 chiamate di disegno separate
...
| pass a schermo intero | fino a 6 | commit 8139be8d |
