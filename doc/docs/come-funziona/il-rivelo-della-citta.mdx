...
È la sequenza di apertura: 10 secondi in cui la città passa dal fil di ferro alla forma vera, a tempo di musica. È anche il momento in cui la demo ha meno margine di tutti, e quasi tutto il resto viene messo in pausa.
