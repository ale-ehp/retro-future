...
Pointer lock con finestra di guardia contro il delta accumulato, fallback a drag oltre 4 px, touch con `passive: false` e dita separate fra look e joystick. Le collisioni sono raggi contro rettangoli arrotondati; l'ordine delle chiamate nel frame è vincolato da una prova sul sorgente.
