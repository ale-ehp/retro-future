...
In una scena in tempo reale i riflessi quasi mai riflettono la scena vera: costerebbe disegnarla 2 volte. Si usano immagini preparate, copie capovolte e scorciatoie matematiche. Questo capitolo dice quali, e dove si vede la differenza.
...
Una cosa da dire con onestà: i valori delle luci vivono a 3 livelli. Nel codice
...
- **Env map tolta a palazzi e piazzole su mobile.** +1,7 fps senza perdita di
  qualità: il pavimento bagnato resta col suo Fresnel, si perde solo una lucentezza
...
- **Anisotropia a 4 su mobile.** Impercettibile: nitido sotto i piedi, un po' più
  morbido lontano.
