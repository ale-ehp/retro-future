...
102 moduli ESM serviti senza bundler, risolti da una importmap. `main.js` monta i sottosistemi in un ordine che una prova verifica sul sorgente; lo stato condiviso è un oggetto mutabile per dominio, e chi costruisce lo fa dentro `initX(deps)` perché gli import girano prima di scena, camera e renderer.
...
modulo è un sottosistema. I quattro grandi sono ognuno un sottosistema solo, e i file che
tenevano insieme mestieri diversi sono stati divisi il 21 settembre. Sulla rete viaggiano in brotli da
