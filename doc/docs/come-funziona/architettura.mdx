...
Di solito il codice di un sito viene impacchettato da un programma che lo comprime e lo unisce in pochi file. Qui non succede: i file arrivano al browser come sono scritti. Questo capitolo spiega perché, e come si tiene in ordine un sistema di 97 pezzi senza quel programma.
