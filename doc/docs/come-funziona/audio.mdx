...
Un solo `AudioContext`, risolto all'uso e pubblicato su `window`, condiviso fra colonna sonora, passi e AnalyserNode. Il clock del brano fa da orologio maestro: il rivelo parte sul beat drop misurato con RMS filtrato a 150 Hz, non su un timer.
